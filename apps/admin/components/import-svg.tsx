...
/**
 * SVG-import flow: drag-drop or paste, POST to /api/import/svg, redirect to
 * the resulting Tier-1 review page. Extracted from the original ImportForm so
 * the URL-import flow can live alongside it without diverging.
 */
